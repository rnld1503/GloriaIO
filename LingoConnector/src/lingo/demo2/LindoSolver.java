...
/* The coefficients of the objective function */
		/* Max 20X1 + 30X2  */
		double coefFunionObjetivo[] = new double[] { 400., 30. };

		/* The right-hand sides of the constraints */
		/* equivalencias de las restricciones */
		double equivalenciasRestricciones[] = new double[] { 50., 60., 100. };
		...
		double adA[] = new double[] { 1., 1., 1., 2. };

		/* The row indices of the nonzero coefficients */
		
		int anRowX[] = new int[] { 0, 2, 1, 2 };
		...
		String varnames[] = { "Variable 1", "Variable 2" };
		String connames[] = { "Restriccion 1", "Restriccion 2", "Restriccion 3" };
